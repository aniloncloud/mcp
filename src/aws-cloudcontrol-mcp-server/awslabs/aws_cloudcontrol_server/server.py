...
async def create_resource(
    ...
    desired_state: dict = Field(
        description="JSON object representing the desired state of the resource"
    ),
    role_arn: Optional[str] = Field(
        default=None, description="Optional IAM role ARN to use for this operation"
    ),
    client_token: Optional[str] = Field(
        default=None, description="Idempotency token for the request"
    ),
) -> Dict:
    ...
    try:
        ...
        response = await asyncio.to_thread(
            cloudcontrol_client.cloudcontrol_client.create_resource, **params
        )

        # Return the progress event
        return {
            "ProgressEvent": {
                "EventTime": response["ProgressEvent"]["EventTime"].isoformat()
                if "EventTime" in response["ProgressEvent"]
                else None,
...
async def get_resource(
    ...
    try:
        ...
        # Make the API call
        response = await asyncio.to_thread(
            cloudcontrol_client.cloudcontrol_client.get_resource, **params
        )
...
async def update_resource(
    ...
    try:
        ...
        # Make the API call
        response = await asyncio.to_thread(
            cloudcontrol_client.cloudcontrol_client.update_resource, **params
        )
...
async def delete_resource(
    ...
    try:
        ...
        # Make the API call
        response = await asyncio.to_thread(
            cloudcontrol_client.cloudcontrol_client.delete_resource, **params
        )
...
async def list_resources(
    ...
    resource_model: Optional[Dict] = Field(
        default=None,
        description="Optional resource model for resources that require additional information",
    ),
    role_arn: Optional[str] = Field(
        default=None, description="Optional IAM role ARN to use for this operation"
    ),
    ...
    try:
        ...
        # Make the API call
        response = await asyncio.to_thread(
            cloudcontrol_client.cloudcontrol_client.list_resources, **params
        )
...
async def list_resource_requests(
    ctx: Context,
    resource_request_status_filter: Optional[Dict] = Field(
        default=None, description="Filter for resource request status"
    ),
    next_token: Optional[str] = Field(default=None, description="Token for pagination"),
) -> Dict:
    ...
    try:
        ...
        elif resource_request_status_filter is not None and hasattr(
            resource_request_status_filter, "default"
        ):
        ...
        # Make the API call
        response = await asyncio.to_thread(
            cloudcontrol_client.cloudcontrol_client.list_resource_requests, **params
        )
        ...
        for summary in response.get("ResourceRequestStatusSummaries", []):
            resource_request_status_summaries.append(
                {
                    "EventTime": summary["EventTime"].isoformat()
                    if "EventTime" in summary
                    else None,
...
async def list_resource_types(
    ...
    filters: Optional[Dict] = Field(
        default=None, description="Optional filters for resource types"
    ),
) -> Dict:
    ...
    try:
        ...
        response = await asyncio.to_thread(
            cloudcontrol_client.cloudformation_client.list_types, **params
        )
            ...
            type_summaries.append(
                {
                    ...
                    "LastUpdated": summary["LastUpdated"].isoformat()
                    if "LastUpdated" in summary
                    else None,
